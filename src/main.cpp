...
void setup()
{
  ...
  ArtDriver M1DRV(5, ("M1DRV"), ArtDriver::DRIVER_TYPE_1, 6, 4, 1, 1, true, 0, 2, 0, 2, 0, 0, 0);  //Драйвер на M1
  ArtDriver M2DRV(10, ("M2DRV"), ArtDriver::DRIVER_TYPE_1, 7, 5, 2, 2, true, 0, 2, 0, 2, 0, 0, 0); //Драйвер на M2
  ArtDriver M3DRV(11, ("M3DRV"), ArtDriver::DRIVER_TYPE_1, 8, 6, 3, 3, true, 0, 2, 0, 2, 0, 0, 0); //Драйвер на M3

  ArtConveyor1AType ConvM3(12, ("ConvM3"), ArtConveyor1AType::CONVEYOR_TYPE_1_EXTERNAL_BARDA, &M3DRV, &M2End, &M3End, false, 30000, 0, 4, 3);
  ArtConveyor1Type ConvM2(13, ("ConvM2"), ArtConveyor1Type::CONVEYOR_TYPE_1, &M2DRV, &M1End, &M2End, &ConvM3, 10000, 0, 2);
  ArtConveyor1Type ConvM1(14, ("ConvM1"), ArtConveyor1Type::CONVEYOR_TYPE_1, &M1DRV, &AfterSiat, &M1End, &ConvM2, 15000, 0, 1);
  //----setup for A31---------------------------------------------------------------------------------------
  ...
  ArtConveyor2Type ConvM6(13, ("Conveyor3"), ArtConveyor2Type::CONVEYOR_TYPE_2, &M6DRV, &M5End, &M6Start, &M6Start2, 10000, 5, 500, 3);
  ArtConveyor1Type ConvM5(14, ("ConvM4"), ArtConveyor1Type::CONVEYOR_TYPE_1, &M5DRV, &PushNoHome, &M5End, &ConvM6, 30000, 0, 2);
  // ArtConveyor1Type ConvM4(15, ("ConvM4"), ArtConveyor1Type::CONVEYOR_TYPE_1, &M4DRV, &B5, &B6, &ConvM5, 20000, 0, 1);
  ArtPusher PusherOnM4(16, ("Podzhim2"), &B6, &B5, &ConvM5, &PusherSV1, &M4DRV);
  //----setup for A32---------------------------------------------------------------------------------------
  /*
    //----setup for A33---------------------------------------------------------------------------------------
  ...
  /*
    ...
    /*
    ArtPalletConveyorWithStoppers ConvM23(20, ("ConvM23"), ArtConveyor1Type::CONVEYOR_TYPE_1, &M23DRV, &M22DRV,
    ...
    ArtDriver M24DRV(9, ("M24DRV"), ArtDriver::DRIVER_TYPE_1, 13, 10, 9, 6, true, 2, 2, 2, 2, 2, 2, 2);   //Драйвер на M24
    ArtDriver M25DRV(10, ("M25DRV"), ArtDriver::DRIVER_TYPE_1, 14, 12, 11, 6, true, 2, 2, 2, 2, 2, 2, 2); //Драйвер на M25
    ArtDriver M26DRV(11, ("M26DRV"), ArtDriver::DRIVER_TYPE_1, 15, 14, 13, 6, true, 2, 2, 2, 2, 2, 2, 2); //Драйвер на M26
    ArtDriver M27DRV(12, ("M27DRV"), ArtDriver::DRIVER_TYPE_1, 16, 16, 15, 6, true, 2, 2, 2, 2, 2, 2, 2); //Драйвер на M27
    ...
    //ArtPodzhim M29Podzhim(3, ("Podzhim2"), &M29Pall, &Podzhim2);
    //ArtPodzhim M28Podzhim(4, ("Podzhim1"), &M28Pall, &Podzhim1);
    ...
    ArtDriver M28DRV(7, ("M28DRV"), ArtDriver::DRIVER_TYPE_1, 15, 14, 13, 6, true, 2, 2, 2, 2, 2, 2, 2); //Драйвер на M28
    ArtDriver M29DRV(8, ("M29DRV"), ArtDriver::DRIVER_TYPE_1, 16, 16, 15, 6, true, 2, 2, 2, 2, 2, 2, 2); //Драйвер на M29

    ArtConveyorPLPType ConvM28(9, ("ConvM30"), ArtConveyor1Type::CONVEYOR_TYPE_1, &M28DRV, &M24UP, &EnterShuttle, &M28Pall, &M28Layer,
                               &Stopper1, &Podzhim1, 50000, 0, 1, 1);
    ArtConveyorPLPType ConvM29(10, ("ConvM31"), ArtConveyor1Type::CONVEYOR_TYPE_1, &M29DRV, &M25UP, &EnterShuttle, &M29Pall, &M29Layer,
                               &Stopper2, &Podzhim2, 50000, 0, 2, 2);
    /*
  ...
  ArtConveyor1TypeNextExtDev BeforWin(11, ("ConvM34"), ArtBasicConveyor::CONVEYOR_TYPE_1_EXTE, &BeforWinding, &ExitShuttle, &PalletOnConvM34, 4000, 0, 8, 2);
  ArtConveyorShuttleType Shuttle(12, ("ConvM32&33"), ArtBasicConveyor::CONVEYOR_TYPE_SHUTTLE, &ShuttleDrv, &OverShuttleDrv, &RangeFinderAnalog, &PalletOnConvM32, &EnterShuttle, &ExitShuttle,
                                 &BeforWin, &EdgeOnShuttle, false, 1, 400000, 100000, 0, 0, 30, 1); // переделать
...
/*
  ...
  ArtDriver M38Drv(8, ("M38DRV"), ArtDriver::DRIVER_TYPE_1, 14, 12, 11, 8, true, 2, 2, 2, 2, 2, 2, 2);  //Драйвер на M38
  ...
  */
  /**/
  //----setup for Dispenser---------------------------------------------------------------------------------------
  ArtSensor PallONConvey(1, ("PallONConvey"), 10, ArtSensor::SENSOR_TYPE_BASIC, 3000, 3000, false);
  ArtSensor PalletsInStack(2, ("PalletsInStack"), 9, ArtSensor::SENSOR_TYPE_BASIC, 0, 0, false);
  ArtSensor Clamp1Open(5, ("Clamp1Open"), 5, ArtSensor::SENSOR_TYPE_BASIC, 0, 0, false);
  ArtSensor Clamp1Close(7, ("Clamp1Close"), 7, ArtSensor::SENSOR_TYPE_BASIC, 0, 0, false);
  ArtSensor Clamp2Open(6, ("Clamp2Open"), 6, ArtSensor::SENSOR_TYPE_BASIC, 0, 0, false);
  ArtSensor Clamp2Close(8, ("Clamp2Close"), 8, ArtSensor::SENSOR_TYPE_BASIC, 0, 0, false);
  ArtSensor TOPCylinderOpen(7, ("TOPCylinderOpen"), 2, ArtSensor::SENSOR_TYPE_BASIC, 200, 0, false);
  ArtSensor TOPCylinderClose(8, ("TOPCylinderClose"), 1, ArtSensor::SENSOR_TYPE_BASIC, 200, 0, false);
  ArtSensor BOTCylinderOpen(9, ("BOTCylinderOpen"), 4, ArtSensor::SENSOR_TYPE_BASIC, 200, 0, false);
  ArtSensor BOTCylinderClose(10, ("BOTCylinderClose"), 3, ArtSensor::SENSOR_TYPE_BASIC, 200, 0, false);
  ...
  while (1)
  {
    /*if (ArtIOClass::getInputState(1))
    {
      curtime = ArtIOClass::ARTTimerGetTime();
      if (curtime - timer1 > 95)
      {
        curOut1 = !curOut1;
        ArtIOClass::setOutputState(1, curOut1);
        timer1 = curtime;
      }
      if (curtime - timer2 > 98)
      {
        curOut2 = !curOut2;
        ArtIOClass::setOutputState(2, curOut2);
        timer2 = curtime;
      }

      if (curtime - timer3 > 100)
      {
        curOut3 = !curOut3;
        ArtIOClass::setOutputState(3, curOut3);
        timer3 = curtime;
      }
    }
    else
    ...
    if (EASYCAT.MainTask() == ESM_OP) // execute the EasyCAT task   if (EASYCAT.MainTask() == ESM_OP)
    {
      ...
      // BeforWin.signalExt =  Shuttle.signalfornext;
      /*
