...
*/
  ...
  ArtSensor M7Perepoln(2, ("B15"), 1, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false); // Фотодатчик переполнения М7 (B15) (тип R)
  ArtSensor M7End(3, ("B7"), 2, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false); // Датчик пушер 1 дома (B7) (тип геркон)
  ArtSensor M8(4, ("B8"), 3, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false); // Датчик пушер 1 НЕ дома (B8) (тип геркон)
  ArtSensor M5Perepoln(5, ("B9"), 4, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false); // Фотодатчик переполнения М5 (B9) (тип R)
  ArtSensor M5End(6, ("B10"), 5, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false); // Фотодатчик на конце М5 (B10) (тип R)
  ArtSensor M6Start(7, ("B11"), 6, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false); // Фотодатчик на начале М6 пикпойнт (B11) (тип BGS)
  ArtSensor M6Start2(8, ("B12"), 7, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false); // Фотодатчик на начале M6 пикпойнт (B12) (тип BGS)
 ...
 /*/----setup for Dispenser---------------------------------------------------------------------------------------
  ArtSensor PallONConvey(1, ("PallONConvey"), 1, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false);
  ArtSensor PalletsInStack(2, ("PalletsInStack"), 2, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false);
  ArtSensor Clamp1Open(3, ("Clamp1Open"), 3, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false);
  ArtSensor Clamp1Close(4, ("Clamp1Close"), 4, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false);
  ArtSensor Clamp2Open(5, ("Clamp2Open"), 5, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false);
  ArtSensor Clamp2Close(6, ("Clamp2Close"), 6, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false);
  ...
  ArtSensor BOTCylinderOpen(9, ("BOTCylinderOpen"), 9, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false);
  ArtSensor BOTCylinderClose(10, ("BOTCylinderClose"), 10, ArtSensor::SENSOR_TYPE_BASIC, 0, 0,false);
