...
ArtSensor M6Start(7, ("B11"), 7, ArtSensor::SENSOR_TYPE_BASIC, 0, 0, false);  // Фотодатчик на начале М6 пикпойнт (B11) (тип BGS)
ArtSensor M6Start2(8, ("B12"), 6, ArtSensor::SENSOR_TYPE_BASIC, 0, 0, false); // Фотодатчик на начале M6 пикпойнт (B12) (тип BGS)
...
ArtConveyor1Type ConvM5(14, ("ConvM4"), ArtConveyor1Type::CONVEYOR_TYPE_1, &M5DRV, &PushNoHome, &M5End, &ConvM6, 20000, 0, 2);
...
/*
  ...
  ArtSensor M28Pall(1, ("B56"), 1, ArtSensor::SENSOR_TYPE_BASIC, 500, 0, false);        // Датчик паллеты на М28 (B56) (тип Инд)
  ...
  ArtSensor M29Pall(8, ("B67"), 8, ArtSensor::SENSOR_TYPE_BASIC, 500, 0, false);        // Датчик паллеты на М29 (B67) (тип Инд)
